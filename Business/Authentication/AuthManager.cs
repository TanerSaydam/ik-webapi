...
namespace Business.Authentication
{
    public class AuthManager : IAuthService
    {
        ...
        public async Task<IDataResult<Token>> Login(LoginAuthDto loginDto)
        {
            ...
            if (user == null)
                user = await _userService.GetByUserName(loginDto.Email);
        ...
        public async Task<IResult> Register(RegisterAuthDto registerDto)
        {
            IResult result = BusinessRules.Run(
                ...
                await CheckIfUserNameExists(registerDto.UserName),
        ...
        private async Task<IResult> CheckIfUserNameExists(string userName)
        {
            var list = await _userService.GetByUserName(userName);
            if (list != null)
            {
